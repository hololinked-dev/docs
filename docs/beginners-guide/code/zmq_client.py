...
spectrometer_proxy = ObjectProxy(
    instance_name="spectrometer", serializer="msgpack", protocol="IPC"
)
...
spectrometer_proxy = ObjectProxy(
    ...
    protocol="TCP",
    serializer="pickle",
    socket_address="tcp://192.168.0.100:6539",
)  # type: OceanOpticsSpectrometer
spectrometer_proxy.serial_number = "USB2+H15897"
